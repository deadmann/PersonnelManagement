...
module AngularUtility {
    ...
    export interface IEsc2Scope extends ng.IScope {
        onEsc2: Function,
        dataOnEsc2: Function,
        onEscape2: Function,
    ...
    class OnEsc2Directive implements ng.IDirective {
        ...
        constructor() {
            ...
            this.link = function (scope: IEsc2Scope, element: IAugmentedJQuery, attrs: ng.IAttributes) {
